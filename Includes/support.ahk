...
GetPlayerNameById(Aufnahme, PlayerName)
	...
	if (A_Hour > 5)
	{
		if (A_Hour < 12)
		{
			...
			sleep 100
			SendChat("/po Ich wünsche ihnen noch einen schönen Tag, " PlayerName "!")
			SendChat("/ct")
			PressedT=0
			Suspend Off
			Hotkey, t, On
	...
	if (A_Hour > 17)
	{
		if (A_Hour < 22)
		{
			...
			SendChat("/po Bei weiteren Fragen, erstelle einfach ein neues Ticket!")
			sleep 100
			SendChat("/po Ich wünsche ihnen noch einen schönen Abend, " PlayerName "!")
			SendChat("/ct")
			PressedT=0
			Suspend Off
			Hotkey, t, On
	...
	if(A_Hour=0)
	{
		...
		SendChat("/po Bei weiteren Fragen, erstelle einfach ein neues Ticket!")
		sleep 100
		SendChat("/po Ich wünsche ihnen noch eine schöne Nacht, " PlayerName "!")
		SendChat("/ct")
		PressedT=0
		Suspend Off
		Hotkey, t, On
...
if (A_Hour > 5)
	{
		...
		{
			sleep 1
			SendChat("/po Hallo " PlayerName ", Schönen Guten Morgen.")
			sleep 100
