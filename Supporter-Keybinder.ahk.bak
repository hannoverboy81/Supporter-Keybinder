...
{
	MsgBox Dieser Keybinder Benötigt Windwos Vista/7
	ExitApp
}
...
Gui, 9:Add, Text, x800 y5 cRed +backgroundtrans gSchließen, [ Schließen ]
...
Gui, 2:Add, DropDownList, x22 y285 w230 h90 vgeschlecht Choose%geschlecht% altsubmit, Männlich|Weiblich
...
if (Eingeloggt = 1)
{
	...
	{	
		...
		{
			If Instr(A_LoopReadLine, "Du musst die Handbremse lösen")
			{
				sendinput {n down}
				sleep 200
				sendinput {n up}
				if(GetVehicleEngineState() == 0)
				{
					SendChat("/me Löst die Handbremse.")
					sleep 1
					SendChat("/motor")
					sleep 1
...
if (Eingeloggt = 1)
{
	...
	;AddChatMessage(0x0000FF, "Drück Jetzt nocheinmal Enter damit das Ganze geht!")
	If (Aufnahme!="")
	{
...
money := GetPlayerMoney()
	...
	if (A_Hour > 11)
	{
		if (A_Hour < 18)
		{
			...
			SetTimer, LInfo, 10000
			sleep 200
			SendChat("wir haben " Time ", Schönen Tag noch!")
			sleep 200
			SendChat("/togloginlogout")
			ShowGameText("~b~Du hast dich Erfolgreich ~g~Eingeloggt.", 2000, 3)
			return
	...
	if (A_Hour > 17)
	{
		if (A_Hour < 22)
		{
			...
			SetTimer, LInfo, 10000
			sleep 200
			SendChat("wir haben " Time ", Schönen Abend :)")
			sleep 200
			SendChat("/togloginlogout")
			ShowGameText("~b~Du hast dich Erfolgreich ~g~Eingeloggt.", 2000, 3)
			return
	...
	if (A_Hour > 21)
	{
		if (A_Hour < 25)
		{
			...
			SetTimer, LInfo, 10000
			sleep 200
			SendChat("wir haben " Time ", Schöne Nacht noch :)")
			sleep 200
			SendChat("/togloginlogout")
			ShowGameText("~b~Du hast dich Erfolgreich ~g~Eingeloggt.", 2000, 3)
			return
...
AddChatMessage(0xFFA000, "Account-Status - Level " score1 " - " wanted1 " Wanteds, Ihr Vermögen: " money "")
SetTimer, LInfo, Off
return
; ===================================
...
SendChat("Versuchen Sie es bitte später erneut.")
SendChat("/h")
SendInput {enter}
} else {
	SendChat("/me sollte sich zuerst einloggen **")
...
sleep 1000
SendChat("/o Nachdem du das Ticket erstellt hast, wird sich ein Supporter um dein Anliegen kümmern.")
sleep 1000
SendChat("/o Du möchtest den Startbonus? Gebe /motd ein und lies dir die Infos durch.")
}
return
...
F2::
	...
	{
		SendChat("Sie Betreten nun die Hitman Base - viel spaß (:")
		sleep 250
		SendChat("/enter")
		return
	}
	...
	{
		SendChat("Sie Verlassen die Hitman Base, Tschüss!")
		sleep 250
		SendChat("/exit")
		return
	}
...
ShowDialog(0, "Textbefehle", "/ot = Ticket öffnen`n/act = Ticket schließen`n/hpset = 100 HP setzen`n/sot = Startbonus Ticket`n/wf = weitere Fragen`n/pk = Abnehmen`n/ab = Anrufbeantworter", "Verlassen")
}
Suspend off
Hotkey, t, On
return
...
sleep 1
SendChat("Mit Numpad 4/6 kannst du Vor/Rückwärts das Lied Changen. ")
sleep 1
SendChat("Mit Numpad 7 kannst du Pause/Start Machen. ")
sleep 1
SendChat("Numpad 1 ist Stop. ")
sleep 1
SendChat("Vorwärts/Rückwärts Spulen kannst du mit Numpad 9/3. ")
sleep 1
SendChat("mit Numpad 8/2 kannst du Laut/Leise Machen. ")
sleep 1
SendChat("um zu sehen was du hörst, klick Numpad 0 ")
Suspend Off
Hotkey, t, On
return
...
{ 
	...
	SendChat("/me Hört Gerade: " orezan_title "")
	Suspend Off
	Hotkey, t, On
}
return
...
Suspend Permit
Sendinput {enter}
SendChat("Verfügbare Bereiche zum Teleportieren:")
...
SendChat("/l")
SendChat("/l")
SendChat(" Kürzel für Teleportation in Los Santos:")
...
SendChat("/l")
SendChat("/l")
SendChat(" Kürzel für Teleportation in San Fierro:")
...
SendChat("/l")
SendChat("/l")
SendChat(" Kürzel für Teleportation in Las Venturas:")
...
SendChat("/l")
SendChat("/l")
SendChat(" Kürzel für Teleportation zu Fraktions Basen:")
...
SendChat("/l")
SendChat("/l")
SendChat(" Sonstige Kürzel für Teleportation:")
...
TextBindTimer(150)
RegisterTextBind("Willkommen in der Adminbase! Bitte nach der Nutzung das Auto zerstören.", 1247.6981,-811.0828,84.1406, 10, 1, 10000, 1)
